    ...
    return (
        <div className=" space-y-10 w-[25%] h-screen flex flex-col justify-between bg-primary py-6 pl-10 text-white">
            <div className="space-y-10 ">
                <h1 className=" text-3xl font-bold underline">Talent Syncro</h1>
                ...
                <div className=" flex flex-col gap-6 text-xl font-semibold">
                    ...
                    <Link className=" pl-5 border-2 border-r-0 py-2 " to={''}>Profile</Link>
                    <Link className=" pl-5 border-2 border-r-0 py-2 " to={''}>Work Sheet</Link>
                </div>
            </div>
            <div className=" self-end pr-5 flex gap-3 items-center text-xl font-semibold">
